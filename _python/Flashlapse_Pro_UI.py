...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 131, 501))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.PositionSlider = QtWidgets.QSlider(self.verticalLayoutWidget)
        self.PositionSlider.setMinimumSize(QtCore.QSize(40, 0))
        self.PositionSlider.setMinimum(65)
        self.PositionSlider.setMaximum(455)
        self.PositionSlider.setOrientation(QtCore.Qt.Vertical)
        self.PositionSlider.setTickPosition(QtWidgets.QSlider.TicksBothSides)
        self.PositionSlider.setTickInterval(10)
        self.PositionSlider.setObjectName("PositionSlider")
        self.verticalLayout_6.addWidget(self.PositionSlider, 0, QtCore.Qt.AlignHCenter)
        self.line_2 = QtWidgets.QFrame(self.verticalLayoutWidget)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.verticalLayout_6.addWidget(self.line_2)
        self.Rangefinder_text_label = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.Rangefinder_text_label.setObjectName("Rangefinder_text_label")
        self.verticalLayout_6.addWidget(self.Rangefinder_text_label)
        self.Rangefinder_data_label = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.Rangefinder_data_label.setFrameShape(QtWidgets.QFrame.Box)
        self.Rangefinder_data_label.setAlignment(QtCore.Qt.AlignCenter)
        self.Rangefinder_data_label.setObjectName("Rangefinder_data_label")
        self.verticalLayout_6.addWidget(self.Rangefinder_data_label)
        self.pushButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.pushButton.setObjectName("pushButton")
        self.verticalLayout_6.addWidget(self.pushButton)
        self.frame = QtWidgets.QFrame(self.tab_2)
        self.frame.setGeometry(QtCore.QRect(150, 10, 291, 501))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.frame.setObjectName("frame")
        self.gridLayoutWidget_3 = QtWidgets.QWidget(self.frame)
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 273, 481))
        ...
        self.pushButton_3.setIconSize(QtCore.QSize(64, 32))
        ...
        self.frame_2.setGeometry(QtCore.QRect(450, 10, 171, 501))
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.frame_2.setObjectName("frame_2")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.frame_2)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 151, 481))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Rangefinder_text_label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">Rangefinder Data</span></p></body></html>"))
        self.Rangefinder_data_label.setText(_translate("MainWindow", "N/A mm"))
