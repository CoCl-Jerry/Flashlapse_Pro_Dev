...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ambient_temperature_offset_doubleSpinBox_2 = QtWidgets.QDoubleSpinBox(self.gridLayoutWidget_9)
        self.ambient_temperature_offset_doubleSpinBox_2.setMinimum(-100.0)
        self.ambient_temperature_offset_doubleSpinBox_2.setMaximum(100.0)
        self.ambient_temperature_offset_doubleSpinBox_2.setObjectName("ambient_temperature_offset_doubleSpinBox_2")
        self.gridLayout_9.addWidget(self.ambient_temperature_offset_doubleSpinBox_2, 0, 5, 1, 1)
        self.soil_temperture_label = QtWidgets.QLabel(self.gridLayoutWidget_9)
        self.soil_temperture_label.setMinimumSize(QtCore.QSize(0, 0))
        self.soil_temperture_label.setObjectName("soil_temperture_label")
        self.gridLayout_9.addWidget(self.soil_temperture_label, 0, 1, 2, 1)
        self.ambient_temperature_offset_pushButton_2 = QtWidgets.QPushButton(self.gridLayoutWidget_9)
        self.ambient_temperature_offset_pushButton_2.setObjectName("ambient_temperature_offset_pushButton_2")
        self.gridLayout_9.addWidget(self.ambient_temperature_offset_pushButton_2, 1, 5, 1, 1)
        self.soil_temperture_value_label = QtWidgets.QLabel(self.gridLayoutWidget_9)
        self.soil_temperture_value_label.setObjectName("soil_temperture_value_label")
        self.gridLayout_9.addWidget(self.soil_temperture_value_label, 0, 2, 2, 1)
        ...
        self.ambient_temperature_graphWidget_3 = PlotWidget(self.tab_9)
        self.ambient_temperature_graphWidget_3.setGeometry(QtCore.QRect(10, 10, 581, 361))
        self.ambient_temperature_graphWidget_3.setObjectName("ambient_temperature_graphWidget_3")
        self.tabWidget_3.addTab(self.tab_9, "")
        self.tab_12 = QtWidgets.QWidget()
        self.tab_12.setObjectName("tab_12")
        self.ambient_temperature_graphWidget_4 = PlotWidget(self.tab_12)
        self.ambient_temperature_graphWidget_4.setGeometry(QtCore.QRect(10, 10, 581, 361))
        self.ambient_temperature_graphWidget_4.setObjectName("ambient_temperature_graphWidget_4")
        self.tabWidget_3.addTab(self.tab_12, "")
        self.tab_13 = QtWidgets.QWidget()
        self.tab_13.setObjectName("tab_13")
        self.ambient_temperature_graphWidget_5 = PlotWidget(self.tab_13)
        self.ambient_temperature_graphWidget_5.setGeometry(QtCore.QRect(10, 10, 581, 361))
        self.ambient_temperature_graphWidget_5.setObjectName("ambient_temperature_graphWidget_5")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.soil_temperture_label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:700;\">Current Reading:</span></p></body></html>"))
        self.ambient_temperature_offset_pushButton_2.setText(_translate("MainWindow", "Confirm Offset"))
        self.soil_temperture_value_label.setText(_translate("MainWindow", "N/A °C"))
